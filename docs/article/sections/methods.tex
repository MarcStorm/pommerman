...
%\begin{figure}[htb]
%    \centerline{\includegraphics[width=0.8\linewidth]{pommerman/plots/epsilon_20.pdf}}
%    \caption{UML of workflow.}\label{fig:uml}
%\end{figure}
%\begin{figure}[htb]
%    \centerline{\includegraphics[width=0.8\linewidth]{pommerman/plots/epsilon_8.pdf}}
%    \caption{UML of workflow.}\label{fig:uml}
%\end{figure}
